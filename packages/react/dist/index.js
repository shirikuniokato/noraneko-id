...
var idSdk = require('@noraneko/id-sdk');
 ...
 */
const NoranekoIDContext = React.createContext(null);
/**
 * Context表示名（デバッグ用）
 */
...
function NoranekoIDProvider({ config, children, loadingComponent, errorComponent, onInitialized, onInitializationError, }) {
    const [state, dispatch] = React.useReducer(noranekoIDReducer, initialState);
    const sdkRef = React.useRef(null);
    const eventListenersRef = React.useRef(new Map());
    // SDK初期化
    React.useEffect(() => {
        let isMounted = true;
        async function initializeSDK() {
            try {
                ...
                // SDK インスタンス作成
                const sdk = new idSdk.NoranekoID(config);
                sdkRef.current = sdk;
                // SDK イベントリスナーを設定
    ...
    // ログイン関数
    const login = React.useCallback(async (options) => {
        if (!sdkRef.current) {
    ...
    // イベントリスナー管理
    const addEventListener = React.useCallback((event, callback) => {
    ...
    const removeEventListener = React.useCallback((event, callback) => {
    ...
    if (state.error && state.isInitializing) {
        ...
        return (jsxRuntime.jsxs("div", { style: { padding: '20px', textAlign: 'center' }, children: [jsxRuntime.jsx("h3", { children: "\u8A8D\u8A3C\u30B7\u30B9\u30C6\u30E0\u521D\u671F\u5316\u30A8\u30E9\u30FC" }), jsxRuntime.jsx("p", { children: state.error.message }), jsxRuntime.jsx("button", { onClick: () => window.location.reload(), children: "\u518D\u8AAD\u307F\u8FBC\u307F" })] }));
    }
    // 初期化中の場合
    if (state.isInitializing) {
        ...
        return (jsxRuntime.jsx("div", { style: { padding: '20px', textAlign: 'center' }, children: jsxRuntime.jsx("p", { children: "\u8A8D\u8A3C\u30B7\u30B9\u30C6\u30E0\u3092\u521D\u671F\u5316\u4E2D..." }) }));
    }
    return (jsxRuntime.jsx(NoranekoIDContext.Provider, { value: contextValue, children: children }));
}
...
function useNoranekoID(options = {}) {
    const context = React.useContext(NoranekoIDContext);
    if (!context) {
...
function ProtectedRoute({ children, fallback, requiredScopes = [], disableAutoLogin = false, loginOptions = {} }) {
    ...
    if (isInitializing || isLoading) {
        return (jsxRuntime.jsx("div", { style: {
                ...
                alignItems: 'center',
                minHeight: '200px'
            }, children: jsxRuntime.jsx("div", { children: "\u8A8D\u8A3C\u72B6\u614B\u3092\u78BA\u8A8D\u4E2D..." }) }));
    }
    // 認証済みの場合は子コンポーネントを表示
    if (isAuthenticated) {
    ...
    if (fallback || disableAutoLogin) {
        ...
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: fallback || jsxRuntime.jsx("div", { children: "\u30ED\u30B0\u30A4\u30F3\u304C\u5FC5\u8981\u3067\u3059" }) });
    }
    // 自動ログインを実行
    React.useEffect(() => {
    ...
    return (jsxRuntime.jsx("div", { style: {
            ...
            alignItems: 'center',
            minHeight: '200px'
        }, children: jsxRuntime.jsx("div", { children: "\u30ED\u30B0\u30A4\u30F3\u51E6\u7406\u4E2D..." }) }));
}
...
function LoginRequired({ children, message = 'このコンテンツにアクセスするにはログインが必要です', loginButtonText = 'ログイン', loginOptions = {}, className, style }) {
    ...
    // 初期化中はローディング表示
    if (isInitializing) {
        return (jsxRuntime.jsx("div", { className: className, style: style, children: jsxRuntime.jsx("div", { style: { textAlign: 'center', padding: '20px' }, children: "\u8A8D\u8A3C\u72B6\u614B\u3092\u78BA\u8A8D\u4E2D..." }) }));
    }
    // 認証済みの場合は子コンポーネントを表示
    if (isAuthenticated) {
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: children });
    ...
    return (jsxRuntime.jsxs("div", { className: className, style: containerStyle, children: [jsxRuntime.jsx("div", { style: messageStyle, children: message }), jsxRuntime.jsx("button", { onClick: handleLogin, disabled: isLoginLoading || isLoading, style: buttonStyle, onMouseOver: (e) => {
...
function ConditionalRender({ authenticated, unauthenticated, loading, error, children }) {
    ...
    // エラー状態
    if (authError && error) {
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: error });
    }
    // 初期化中またはローディング中
    if (isInitializing || isLoading) {
        if (loading) {
        ...
        return (jsxRuntime.jsx("div", { style: {
                ...
                alignItems: 'center',
                padding: '20px'
            }, children: jsxRuntime.jsx("div", { children: "\u8AAD\u307F\u8FBC\u307F\u4E2D..." }) }));
    }
    // 認証済み
    if (isAuthenticated) {
        // childrenがある場合はchildrenを優先、なければauthenticatedを使用
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: children || authenticated });
    }
    // 未認証
    if (unauthenticated) {
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: unauthenticated });
    }
    // 何も指定されていない場合はnullを返す
    return null;
}
function AuthenticatedOnly({ children, fallback }) {
    return (jsxRuntime.jsx(ConditionalRender, { authenticated: children, unauthenticated: fallback }));
}
function UnauthenticatedOnly({ children, fallback }) {
    return (jsxRuntime.jsx(ConditionalRender, { unauthenticated: children, authenticated: fallback }));
}
...
function withNoranekoID(WrappedComponent) {
    const WithNoranekoIDComponent = (props) => {
        ...
        return (jsxRuntime.jsx(WrappedComponent, { ...props, noranekoID: noranekoIDData }));
    };
...
function withAuthRequired(WrappedComponent, options = {}) {
    ...
    const WithAuthRequiredComponent = (props) => {
        ...
        // 未認証の場合
        if (Fallback) {
            return jsxRuntime.jsx(Fallback, {});
        }
        // 自動ログインを実行
        React.useEffect(() => {
...
Object.defineProperty(exports, "AuthenticationError", {
    enumerable: true,
    get: function () { return idSdk.AuthenticationError; }
});
Object.defineProperty(exports, "ConfigurationError", {
    enumerable: true,
    get: function () { return idSdk.ConfigurationError; }
});
Object.defineProperty(exports, "ErrorCode", {
    enumerable: true,
    get: function () { return idSdk.ErrorCode; }
});
Object.defineProperty(exports, "NetworkError", {
    enumerable: true,
    get: function () { return idSdk.NetworkError; }
});
Object.defineProperty(exports, "NoranekoIDError", {
    enumerable: true,
    get: function () { return idSdk.NoranekoIDError; }
});
Object.defineProperty(exports, "PKCEError", {
    enumerable: true,
    get: function () { return idSdk.PKCEError; }
});
Object.defineProperty(exports, "StorageError", {
    enumerable: true,
    get: function () { return idSdk.StorageError; }
});
Object.defineProperty(exports, "UnsupportedBrowserError", {
    enumerable: true,
    get: function () { return idSdk.UnsupportedBrowserError; }
});
exports.AuthenticatedOnly = AuthenticatedOnly;
exports.ConditionalRender = ConditionalRender;
exports.LoginRequired = LoginRequired;
exports.NoranekoIDProvider = NoranekoIDProvider;
exports.ProtectedRoute = ProtectedRoute;
exports.UnauthenticatedOnly = UnauthenticatedOnly;
exports.useAccessToken = useAccessToken;
exports.useAuthActions = useAuthActions;
exports.useAuthState = useAuthState;
exports.useNoranekoID = useNoranekoID;
exports.useUserInfo = useUserInfo;
exports.withAuthRequired = withAuthRequired;
exports.withNoranekoID = withNoranekoID;
