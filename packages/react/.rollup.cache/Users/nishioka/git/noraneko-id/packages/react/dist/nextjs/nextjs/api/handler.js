 ...
 */
export function createNoranekoIDHandler(config) {
    const cookieConfig = {
        prefix: 'noraneko',
...
export function createDefaultNoranekoIDHandler() {
    ...
    if (!issuer) {
        throw new Error('Missing issuer configuration. Set NORANEKO_ISSUER or NEXT_PUBLIC_API_URL environment variable.');
    }
