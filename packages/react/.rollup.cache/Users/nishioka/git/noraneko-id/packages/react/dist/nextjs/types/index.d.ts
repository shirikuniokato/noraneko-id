...
import type { NoranekoIDConfig, User, AuthOptions, LogoutOptions, TokenResponse, NoranekoIDEventType, EventCallback } from '@noraneko/id-sdk';
...
export interface NoranekoIDContextValue extends UseNoranekoIDResult {
    ...
    sdk: any;
    /** イベントリスナー登録 */
    addEventListener: <T extends NoranekoIDEventType>(event: T, callback: EventCallback<T>) => void;
    /** イベントリスナー削除 */
    removeEventListener: <T extends NoranekoIDEventType>(event: T, callback: EventCallback<T>) => void;
}
