 ...
 * ```
 */
export declare function withNoranekoID<P extends object = {}>(WrappedComponent: React.ComponentType<P & WithNoranekoIDProps>): React.ComponentType<P>;
/**
 * 認証が必要なコンポーネント用のHOC
 ...
 */
export declare function withAuthRequired<P extends object = {}>(WrappedComponent: React.ComponentType<P & WithNoranekoIDProps>, options?: WithAuthRequiredOptions): React.ComponentType<P>;
//# sourceMappingURL=withNoranekoID.d.ts.map